...
// read in garki village data anoph gamb 
	...
	garkiDatGam.garki408 = { { 19,99 },{ 33,670 },{ 47,1266 },{ 61,876 },{ 75,1340 },{ 89,227 },{ 103,513 },{ 117,49 },{ 131,19 },{ 145,15 },{ 158,7 } ,{ 172,15 },{186,2} };
	...
	//{{ 235,0 },{ 249,1 },{ 263,2 },{ 276,1 },{ 291,0 },
	garkiDatGam.garki553_2 = { { 304,3 },{ 319,0 },{ 333,4 },{ 347,17 },{ 362,33 },{ 376,110 },{ 390,122 },{ 404,44 },{ 418,48 } ,{ 434,144 },{ 448,139 },{ 462,20 },{ 476,13 } ,{ 490,0 },{ 504,1 }, { 518, 0 } };

	//{ 532,0 }, { 546,0 }, { 560,1 }, { 588,0 }, { 602,0 }, { 616,0 }, { 630,1 }, { 644,1 }, { 658,0 }, { 672,2 },
	//{ { 686,0 }, { 700,1 }, { 714,1 }, { 728,3 }, { 742,12 }, { 756,39 }, { 770,171 }, { 784,740 }, { 798,544 } , { 812,305 }, { 826,60 }, { 840,3 }, { 854,1 } };
	
	garkiDatGam.garki802 = { { 18,69 },{ 32,285 },{ 46,66 },{ 60,20 },{ 74,103 },{ 88,67 },{ 102,6 },{ 116,8 },{ 130,3 },{ 144,2 },{ 158,0 },{ 171,2 } ,{ 185,0 },{ 199,0 },{ 212,0 },{ 227,0 },{ 241,0 } };
	//{ 255,0 },{ 269,0 },{ 283, 2 },
	garkiDatGam.garki802_2 = { { 297,0 },{ 311,2 },{ 325,3 },{ 339,2 },{ 353,7 } ,{ 368,39 },{ 382,17 },{ 396,13 },{ 410,13 },{ 424,21 },{ 440,24 },{ 454,12 },{ 468,0 },{ 482,3 },{ 496,0 },{ 510,0 }, { 524,0 } }; 
	 //{ 538,0 }, { 552,0 },{ 566,0 },{ 580,0 },{ 594,0 },{ 608,0 },{ 622,0 },{ 636,0 },{ 650,0 },
	//{{663,0},{678,0},{ 692,1 } ,{ 706,4 } ,{ 720,11 },{ 734,6 },{ 748,7 },{ 762,76 },{ 776,221 },{ 790,213 },{ 804,44 },{ 818,35 },{ 832,3 },{ 846,0 } };

	garkiDatGam.garki801 = { { 18,36 },{ 32,249 },{ 46,118 },{ 60,69 },{ 74,250 },{ 88,93 },{ 102,68 },{ 116,24 },{ 130,11 },{ 144,5 },{ 158,0 } ,{ 171,0 } ,{ 185,0 },{ 199,0 },{ 212,0 },{ 227,0 },{ 241,0 } };
	//{ 255,0 },{ 269,1 },{ 283, 1 },
	garkiDatGam.garki801_2 = {{ 297,1 },{ 311,0 },{ 325,3 },{ 339,5 },{ 353,6 } ,{ 368,83 },{ 382,23 },{ 396,24 },{ 410,41 },{ 424,61 },{ 440,63 },{ 454,14 },{ 468,5 },{ 482,4 },{ 496,0 },{ 510,0 }, { 524,0 } };
	 //{{ 538,1 }, { 552,0 },{ 566,0 },{ 580,0 },{ 594,0 },{ 608,0 },{ 622,0 },{ 636,0 },{ 650,0 },
    // {{ 663,0 },{ 678,1 },{ 692,1 } ,{ 706,3 } ,{ 720,8 },{ 734,24 },{ 748,25 },{ 762,175 },{ 776,221 },{ 790,777 },{ 804,329 },{ 818,167 },{ 832,21 },{ 846,1 } };
		...
		{ "w", initParms.w },{ "n", initParms.n },{ "z1", initParms.z1 },{ "z2", initParms.z2 },{ "z3", initParms.z3 },{ "z4", initParms.z4 },{ "z5", initParms.z5 },{ "z6", initParms.z6 },{ "z7", initParms.z7 },{ "z8", initParms.z8 },
		{ "sf1", initParms.sf1 } ,{ "sf2", initParms.sf2 } ,{ "sf3", initParms.sf3 }   ,{ "sf4", initParms.sf4 } ,{ "sf5", initParms.sf5 } ,{ "sf6", initParms.sf6 } ,{ "sf7", initParms.sf7 } ,{ "sf8", initParms.sf8 }
