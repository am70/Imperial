...
void pFitFunc(int particles, pMMHres results, obsDatX obsDat, modParms prms, string outputFile, string dFunc) {
	...
	myfile << "initParms.uoE = " << prms.uoE << endl << "initParms.uoL  = " << prms.uoL << endl << " initParms.uP = " << prms.uP << endl << "initParms.Y = " << prms.Y << endl << "initParms.w = " << prms.w << endl
		<< "initParms.n = " << prms.n << endl << "initParms.z1 = " << prms.z1 << endl << "initParms.z2 = " << prms.z2 << endl << "initParms.z3 = " << prms.z3 << endl << "initParms.z4 = " << prms.z4 << endl << "initParms.z5 = " << prms.z5 << endl << "initParms.z6 = " << prms.z6 << endl
		<< "initParms.sf1 = " << prms.sf1 << endl << "initParms.sf2 = " << prms.sf2 << endl << "initParms.sf3 = " << prms.sf3 << endl << "initParms.sf4 = " << prms.sf4 << endl << "initParms.sf5 = " << prms.sf5 << endl << "initParms.sf6 = " << prms.sf6 << endl <<
