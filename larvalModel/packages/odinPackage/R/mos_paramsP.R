...
list(G0=G0,time1=time1,E0=E0,L0=L0,P0=P0,M0=M0,rF = rF, dE = dE, dL = dL, dP = dP, uoE = uoE, uoL = uoL, uP = uP, uM = uM, B = B, Y = Y, S = S, Emax = Emax, tr = tr, sf = sf, dt = dt, o = o, n = n,Mg=Mg, time2 = time2)
